...
SELECT F.EMPNO, F.ENAME, F.JOB, F.MGR, F.HIREDATE, F.SAL, F.COMM, F.DEPTNO
FROM EMP E, EMP F
WHERE E.ENAME ='SMITH' AND E.JOB = F.JOB;
...
--SMITH 제외
SELECT S.ENAME, S.SAL
FROM EMP S, EMP E
WHERE E.ENAME = 'SMITH' AND S.SAL >= E.SAL AND S.ENAME != 'SMITH';
