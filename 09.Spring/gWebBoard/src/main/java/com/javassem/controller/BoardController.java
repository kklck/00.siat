...
public class BoardController {
	...
	//후에 검색 기능에 사용하려고 vo 매개변수 넣음
	@RequestMapping("getBoardList.do")
	public void getBoardLsit(Model m, BoardVO vo) {
		System.out.println("getBoardList 요청");
		m.addAttribute("boardList",boardService.getBoardList(vo));//List<Board>를 반환
	}
