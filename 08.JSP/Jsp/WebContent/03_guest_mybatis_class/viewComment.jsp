...
<script>
	$(function(){
		$("#btnModify").click(function(){
			window.location.href="updateCommentForm.jsp?cId=<%=commentNo%>&userId=<%=comment.getUserId()%>&Content=<%=comment.getCommentContent()%>" ;			
		})
	})
</script>
</head>
...
<table border="1">
		...
		<tr><td colspan="2">
				...
				<input type="button" id="btnDelete" value="삭제" onclick="location.href='deleteComment.jsp?cId='+<%=commentNo%>"/>
				</td></tr>
</table>
</body>
</html>