...
public class GuestControl extends HttpServlet {
	...
	private void initCommand(){
		...
		commandMap.put("main-page",	new CommandNull("main.jsp") );//DB 안갈 때
		commandMap.put("list-page",	new CommandList("listMessage.jsp") );//DB 갈 때
		// 나머지도 추가하기		
		commandMap.put("input-form", new CommandNull("insertMessage.jsp") );
		commandMap.put("input-do",	new CommandInput("saveMessage.jsp") );//DB 갈 때
		commandMap.put("delete-form", new CommandNull("deleteMessage.jsp") );
		commandMap.put("delete-do",	new CommandDelete("deleteConfirm.jsp") );//DB 갈 때
